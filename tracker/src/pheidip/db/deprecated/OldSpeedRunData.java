...
public class OldSpeedRunData extends OldDataInterface implements SpeedRunData
{
  ...
  public OldSpeedRunData(OldDonationDataAccess manager)
  {
    super(manager);
  }
  ...
  /* (non-Javadoc)
 * @see pheidip.db.SpeedRunData#getSpeedRunById(int)
 */
@Override
public synchronized SpeedRun getSpeedRunById(int runId)
  ...
  /* (non-Javadoc)
 * @see pheidip.db.SpeedRunData#insertSpeedRun(pheidip.objects.SpeedRun)
 */
@Override
public synchronized void insertSpeedRun(SpeedRun speedRun)
  ...
  /* (non-Javadoc)
 * @see pheidip.db.SpeedRunData#deleteSpeedRun(int)
 */
@Override
public synchronized void deleteSpeedRun(int runId)
  ...
  /* (non-Javadoc)
 * @see pheidip.db.SpeedRunData#updateSpeedRun(pheidip.objects.SpeedRun)
 */
@Override
public synchronized void updateSpeedRun(SpeedRun run)
  ...
  /* (non-Javadoc)
 * @see pheidip.db.SpeedRunData#getAllSpeedRuns()
 */
@Override
