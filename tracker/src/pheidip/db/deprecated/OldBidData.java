...
public class OldBidData extends OldDataInterface implements BidData
{
  ...
  public OldBidData(OldDonationDataAccess manager)
  {
    super(manager);
  }
  ...
  /* (non-Javadoc)
 * @see pheidip.db.BidData#getAllBids()
 */
@Override
public synchronized List<Bid> getAllBids()
  ...
  /* (non-Javadoc)
 * @see pheidip.db.BidData#getChoiceById(int)
 */
@Override
public synchronized Choice getChoiceById(int choiceId)
  ...
  /* (non-Javadoc)
 * @see pheidip.db.BidData#insertChoice(pheidip.objects.Choice)
 */
@Override
public synchronized void insertChoice(Choice choice)
  ...
  /* (non-Javadoc)
 * @see pheidip.db.BidData#updateChoice(pheidip.objects.Choice)
 */
@Override
public synchronized void updateChoice(Choice choice)
  ...
  /* (non-Javadoc)
 * @see pheidip.db.BidData#getChoicesBySpeedrun(int)
 */
@Override
public synchronized List<Choice> getChoicesBySpeedrun(int speedRunId)
  {
    ...
    try
    {
      ...
      {
        results.add(OldBidData.extractChoice(queryResult));
      }
    }
    catch (SQLException e)
    {
  ...
  /* (non-Javadoc)
 * @see pheidip.db.BidData#deleteChoice(int)
 */
@Override
public synchronized void deleteChoice(int choiceId)
  ...
  /* (non-Javadoc)
 * @see pheidip.db.BidData#getChoiceOptionById(int)
 */
@Override
public synchronized ChoiceOption getChoiceOptionById(int optionId)
  ...
  /* (non-Javadoc)
 * @see pheidip.db.BidData#insertChoiceOption(pheidip.objects.ChoiceOption)
 */
@Override
public synchronized void insertChoiceOption(ChoiceOption choiceOption)
  ...
  /* (non-Javadoc)
 * @see pheidip.db.BidData#updateChoiceOption(pheidip.objects.ChoiceOption)
 */
@Override
public synchronized void updateChoiceOption(ChoiceOption option)
  ...
  /* (non-Javadoc)
 * @see pheidip.db.BidData#getChoiceOptionsByChoiceId(int)
 */
@Override
public synchronized List<ChoiceOption> getChoiceOptionsByChoiceId(int choiceId)
  {
    ...
    try
    {
      ...
      while (queryResult.next())
      {
        results.add(OldBidData.extractChoiceOption(queryResult));
      }
    }
    catch (SQLException e)
    {
  ...
  /* (non-Javadoc)
 * @see pheidip.db.BidData#deleteChoiceOption(int)
 */
@Override
public synchronized void deleteChoiceOption(int optionId)
  ...
  /* (non-Javadoc)
 * @see pheidip.db.BidData#getChallengeById(int)
 */
@Override
public synchronized Challenge getChallengeById(int challengeId)
  ...
  /* (non-Javadoc)
 * @see pheidip.db.BidData#insertChallenge(pheidip.objects.Challenge)
 */
@Override
public synchronized void insertChallenge(Challenge challenge)
  ...
  /* (non-Javadoc)
 * @see pheidip.db.BidData#updateChallenge(pheidip.objects.Challenge)
 */
@Override
public synchronized void updateChallenge(Challenge challenge)
  ...
  /* (non-Javadoc)
 * @see pheidip.db.BidData#getChallengesBySpeedrun(int)
 */
@Override
public synchronized List<Challenge> getChallengesBySpeedrun(int speedRunId)
  {
    ...
    try
    {
      ...
      while (queryResult.next())
      {
        results.add(OldBidData.extractChallenge(queryResult));
      }
    }
    catch (SQLException e)
    {
  ...
  /* (non-Javadoc)
 * @see pheidip.db.BidData#getChoiceOptionTotal(int)
 */
@Override
public synchronized BigDecimal getChoiceOptionTotal(int optionId)
  ...
  /* (non-Javadoc)
 * @see pheidip.db.BidData#getChallengeTotal(int)
 */
@Override
public synchronized BigDecimal getChallengeTotal(int challengeId)
  ...
  /* (non-Javadoc)
 * @see pheidip.db.BidData#deleteChallenge(int)
 */
@Override
public synchronized void deleteChallenge(int challengeId)
  ...
  /* (non-Javadoc)
 * @see pheidip.db.BidData#getAllChoiceOptions()
 */
@Override
