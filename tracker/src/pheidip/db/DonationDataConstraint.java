...
public enum DonationDataConstraint
{
  ...
  BidFKSpeedRun("This SpeedRun still has a Bid linked to it."),
  BidNameUnique("There is another bid with this name."),
  ...
  DonationBidFKDonation("A Bid is still linked to this Donation."),
