...
public class ChallengePanel extends EntityPanel
{
  ...
  private void initializeGUI()
  {
    ...
    gbc_totalCollectedLabel.gridy = 5;
  ...
  {
    this.challengeControl.updateData(this.nameField.getText(), new BigDecimal(this.amountField.getText()), this.descriptionTextArea.getText());
  }
}
